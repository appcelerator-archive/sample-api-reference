 ...
 * Copyright (c) 2009-2011 by TiAPIRef, Inc. All Rights Reserved.
...
//@interface TiAPIRefObject : NSObject
//@end

@interface TiAPIRefObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiAPIRefObject class]])
		{
			for (NSString *key in [[(TiAPIRefObject*)o modules] allKeys])
			{
