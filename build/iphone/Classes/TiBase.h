...
// in simulator we redefine to format for TiAPIRef Developer console
...
{\
	NSString * exceptionName = [@"org.tiapiref." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiapiref";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiAPIRefNativeItemNone = -1, 
	UITiAPIRefNativeItemSpinner = -2,
	UITiAPIRefNativeItemProgressBar = -3,
	
	UITiAPIRefNativeItemSlider = -4,
	UITiAPIRefNativeItemSwitch = -5,
	UITiAPIRefNativeItemMultiButton = -6,
	UITiAPIRefNativeItemSegmented = -7,
	
	UITiAPIRefNativeItemTextView = -8,
	UITiAPIRefNativeItemTextField = -9,
	UITiAPIRefNativeItemSearchBar = -10,
	
	UITiAPIRefNativeItemPicker = -11,
	UITiAPIRefNativeItemDatePicker = -12,
	
	UITiAPIRefNativeItemInfoLight = -13,
	UITiAPIRefNativeItemInfoDark = -14,
	
	UITiAPIRefNativeItemDisclosure = -15,
	
	UITiAPIRefNativeItemContactAdd = -16
};
